...
C8H::C8H()
{
	...
	ND_ = 24; // number of degree of freedom of each element
...
bool C8H::Read(ifstream& Input, unsigned int Ele, CMaterial* MaterialSets, CNode* NodeList)
{
	...
	ElementMaterial_ = static_cast<C8HMaterial*>(MaterialSets) + MSet - 1; //stored in local node number
...
//	has 21 elements
unsigned int C8H::SizeOfStiffnessMatrix() { return 300; } // reture the number df stiffness matrix
...
void C8H::ElementStress(double* stressHex, double* Displacement)
{
	...
	// stress recovery for stress on nodes_
...
#ifdef _VIB_
void C8H::ElementMass(double* mass) {
}
#endif
